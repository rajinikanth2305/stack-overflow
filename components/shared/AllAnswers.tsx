...
import Filter from "./HomeFilter/Filter";
      ...
      <div>
        {result.answers.map((answer) => (
          <article key={answer._id} className="light-border border-b py-10">
            <div className="flex items-center justify-between">
              <div className="mb-8 flex flex-col-reverse w-full justify-between gap-5 sm:flex-row sm:items-center sm:gap-2 sm:justify-between">
                <Link
